package PDF::Builder::Content::Column;
...
# Column_docs.pm, and any examples/ changes.
# update Examples on website (AT release)
...
PDF::Builder::Content::Column - High level language formatting methods
