...
sub column {
    my @results = PDF::Builder::Content::Column::column(@_);
    return @results;
}

# sub init_state {   in PDF::Builder
# sub pass_start_state {   in PDF::Builder

sub pass_end_state {
    my @results = PDF::Builder::Content::Column::pass_end_state(@_);
    return @results;
}
